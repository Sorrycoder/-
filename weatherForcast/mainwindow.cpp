...
bool MainWindow::eventFilter(QObject *watched, QEvent *event)
{
        ...
        if(watched==ui->widget_0405&&event->type()==QEvent::Paint){//如果监听到0404窗口，并且是绘画事件
         ...
         return QMainWindow::eventFilter(watched, event);//返回事件，不能截断掉事件

}

void MainWindow::parseWeatherJsonData7(QByteArray rawData)
{
...
void MainWindow::drawTempHighLine()
{
...
void MainWindow::drawTempLowLine()
{
...
void MainWindow::on_pushButton_Search_clicked()//通过输入城市名查询更新界面
{
...
void MainWindow::on_lineEdit_City_returnPressed()//按下enter，
{
